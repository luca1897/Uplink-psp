...
public:
    ...
    core::stringw BatteryLifePerc,BatteryLifeTime,BatteryTemp,IsPowerOnline,IsBatteryExist,FreeMemory,CpuClock,BusClock,FirmwareVersion,EthernetAddress,LocalIp;
